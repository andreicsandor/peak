...
public class NewPersonDTO {
    ...
    public NewPersonDTO(String username, String password, String firstName, String lastName, Date birthdate, String gender, Integer weight, Integer height, Integer weeklyWorkouts) {
