...
### Route comparison using GPX files
### Personalised performance recommendations based on route, weather, and user data
### Real-time weather data integration
### Activity tagging and history tracking

# Technologies Used
**Frontend Technologies**: JavaScript Vanilla, CSS, HTML
**Backend Technologies**: Java, Spring Boot, Spring Security, Spring Data, Hibernate, Java Persistence API (JPA), JWT for authentication
**Database**: Microsoft SQL Server
**Tools**: Docker for containerisation of DB, Postman for testing APIs, Vite for FE builds
